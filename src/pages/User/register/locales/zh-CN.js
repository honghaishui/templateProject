 ...
 * @LastEditTime: 2021-01-12 10:44:03
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \antdPro\src\pages\User\register\locales\zh-CN.js
 */
export default {
  ...
  'userandregister.register-result.activation-email': '激活邮件已发送到你的邮箱中，邮件有效期为24小时。请及时登录邮箱，点击邮件中的链接激活帐户。',
  'userandregister.register-result.back-home': '返回首页',
  'userandregister.register-result.view-mailbox': '查看邮箱',
  'userandregister.email.required': '请输入用户名！',
  ...
  'userandregister.email.placeholder': '用户名',
